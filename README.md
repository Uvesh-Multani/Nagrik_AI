...
1. [Frontend Page Routing & Layouts](#chapter-1-frontend-page-routing--layouts)
2. [AI Conversation System](#chapter-2-ai-conversation-system)
3. [User Authentication & Profiles](#chapter-3-user-authentication--profiles)
4. [Static Content Pages](#chapter-4-static-content-pages)
5. [Reusable UI Components](#chapter-5-reusable-ui-components)
